...
//создаём главное окно  
  ...
  g_signal_connect(drag, "drag_begin", G_CALLBACK(drag_begin), drawing_area);
  g_signal_connect(drag, "drag_update", G_CALLBACK(drag_update), drawing_area);
  g_signal_connect(drag, "drag_end", G_CALLBACK(drag_end), drawing_area);
